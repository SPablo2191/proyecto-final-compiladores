...
def p_pin(p):
    """pin : DEF PIN inicioParentesis variable dosPuntos SAL finParentesis finLinea
            | DEF PIN inicioParentesis variable dosPuntos ENT finParentesis finLinea"""
...
def p_definir(p):
    """definir  : DEFINIR inicioParentesis int variable asig numero finParentesis finLinea 
                | DEFINIR inicioParentesis float variable asig numero finParentesis finLinea 
                | DEFINIR inicioParentesis string variable asig comilla variable comilla finParentesis finLinea 
                | DEFINIR inicioParentesis bool variable asig valor finParentesis finLinea 
                | DEFINIR inicioParentesis int variable finParentesis finLinea 
                | DEFINIR inicioParentesis float variable finParentesis finLinea 
                | DEFINIR inicioParentesis string variable finParentesis finLinea 
                | DEFINIR inicioParentesis bool variable finParentesis finLinea 
                """
...
def p_reservadas(p):
    ...
    traductorArduino(p, cb_p_reservadas,
                     is_first_reserved=is_first_reserved, is_reserved=True)
    pass
