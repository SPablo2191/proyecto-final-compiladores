...
_lr_productions = [
  ...
  ('cuerpo -> adelante cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',24),
  ('cuerpo -> atras cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',25),
  ('cuerpo -> izquierda cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',26),
  ('cuerpo -> derecha cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',27),
  ('cuerpo -> esperar cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',28),
  ('cuerpo -> parar cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',29),
  ('cuerpo -> if cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',30),
  ('cuerpo -> while cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',31),
  ('cuerpo -> funcion cuerpo','cuerpo',2,'p_cuerpo','analizadorSintactico.py',32),
  ('cuerpo -> empty','cuerpo',1,'p_cuerpo','analizadorSintactico.py',33),
  ('pin -> DEF PIN inicioParentesis variable dosPuntos tipoPin finParentesis finLinea','pin',8,'p_pin','analizadorSintactico.py',37),
  ('tipoPin -> SAL','tipoPin',1,'p_tipoPin','analizadorSintactico.py',48),
  ('tipoPin -> ENT','tipoPin',1,'p_tipoPin','analizadorSintactico.py',49),
  ('incluir -> INCLUIR inicioParentesis comilla variable finLinea variable comilla finParentesis finLinea','incluir',9,'p_incluir','analizadorSintactico.py',53),
  ('definir -> DEFINIR inicioParentesis tipo variable asig valor finParentesis finLinea','definir',8,'p_definir','analizadorSintactico.py',61),
  ('definir -> DEFINIR inicioParentesis tipo variable finParentesis finLinea','definir',6,'p_definir','analizadorSintactico.py',62),
  ('tipo -> int','tipo',1,'p_tipo','analizadorSintactico.py',68),
  ('tipo -> float','tipo',1,'p_tipo','analizadorSintactico.py',69),
  ('tipo -> string','tipo',1,'p_tipo','analizadorSintactico.py',70),
  ('tipo -> bool','tipo',1,'p_tipo','analizadorSintactico.py',71),
  ('valor -> numero','valor',1,'p_valor','analizadorSintactico.py',75),
  ('valor -> comilla variable comilla','valor',3,'p_valor','analizadorSintactico.py',76),
  ('valor -> true','valor',1,'p_valor','analizadorSintactico.py',77),
  ('valor -> false','valor',1,'p_valor','analizadorSintactico.py',78),
  ('asignar -> variable asig valor finLinea','asignar',4,'p_asignar','analizadorSintactico.py',82),
  ('asignar -> variable asig variable finLinea','asignar',4,'p_asignar','analizadorSintactico.py',83),
  ('finFuncion -> inicioParentesis finParentesis finLinea','finFuncion',3,'p_finFuncion','analizadorSintactico.py',88),
  ('adelante -> ADEL finFuncion','adelante',2,'p_adelante','analizadorSintactico.py',92),
  ('atras -> ATR finFuncion','atras',2,'p_atras','analizadorSintactico.py',100),
  ('izquierda -> IZQ finFuncion','izquierda',2,'p_izquierda','analizadorSintactico.py',106),
  ('derecha -> DER finFuncion','derecha',2,'p_derecha','analizadorSintactico.py',112),
  ('parar -> STOP finFuncion','parar',2,'p_parar','analizadorSintactico.py',118),
  ('esperar -> ESP inicioParentesis numero finParentesis finLinea','esperar',5,'p_esperar','analizadorSintactico.py',124),
  ('predicado -> false','predicado',1,'p_predicado','analizadorSintactico.py',130),
  ('predicado -> true','predicado',1,'p_predicado','analizadorSintactico.py',131),
  ('predicado -> valor operadorComp valor','predicado',3,'p_predicado','analizadorSintactico.py',132),
  ('predicado -> inicioParentesis predicado operadorLog predicado finParentesis','predicado',5,'p_predicado','analizadorSintactico.py',133),
  ('operadorLog -> AND','operadorLog',1,'p_operadorLog','analizadorSintactico.py',136),
  ('operadorLog -> OR','operadorLog',1,'p_operadorLog','analizadorSintactico.py',137),
  ('if -> IF predicado BEGIN cuerpo END else','if',6,'p_if','analizadorSintactico.py',140),
  ('else -> ELSE BEGIN cuerpo END','else',4,'p_else','analizadorSintactico.py',143),
  ('else -> empty','else',1,'p_else','analizadorSintactico.py',144),
  ('while -> WHILE predicado BEGIN cuerpo END','while',5,'p_while','analizadorSintactico.py',147),
  ('funcion -> FUNC inicioParentesis parametros finParentesis retorno finLinea','funcion',6,'p_funcion','analizadorSintactico.py',150),
  ('retorno -> dosPuntos tipo','retorno',2,'p_retorno','analizadorSintactico.py',154),
  ('retorno -> empty','retorno',1,'p_retorno','analizadorSintactico.py',155),
  ('parametros -> tipo dosPuntos variable','parametros',3,'p_parametros','analizadorSintactico.py',158),
  ('parametros -> tipo dosPuntos variable coma parametros','parametros',5,'p_parametros','analizadorSintactico.py',159),
  ('parametros -> empty','parametros',1,'p_parametros','analizadorSintactico.py',160),
  ('empty -> <empty>','empty',0,'p_empty','analizadorSintactico.py',163),
]
